        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-[90vw] sm:max-w-md dark:bg-dark-200 bg-light-200 dark:text-light-100 text-dark-300 dark:border-dark-100 border-light-400">
            ...
            <Accordion type="single" collapsible className="w-full">
              {/* Features */}
              <SettingsCategory title="Features" icon={<Sparkles size={18} className="text-premium-500 mr-2" />} items={[{
              title: "User Scans QR",
              subitems: ["Voice Output for Blind Users", "AR/Text for General Users"]
            }, {
              title: "QR Code Verification",
              subitems: ["Blockchain Ledger Check", "Fake QR Code Alerts"]
            }, {
              title: "Cloud Backend & Data",
              subitems: ["Brand Portal", "AWS/Azure Storage", "APIs for Auto Updates"]
            }, {
              title: "Privacy & Security",
              subitems: ["Edge Computing (On-Device Processing)", "AES-256 Encryption", "User-Controlled Privacy"]
            }]} />
              
              {/* Theme */}
              <SettingsCategory title="Theme" icon={<Palette size={18} className="text-premium-500 mr-2" />} items={[{
              title: "Appearance",
              subitems: ["Light Mode", "Dark Mode", "System Default"],
              customContent: <ThemeToggle inSettings={true} />
            }, {
              title: "Color Schemes",
              subitems: ["Premium Blue", "Night Sky", "Ocean Breeze"]
            }, {
              title: "Accessibility",
              subitems: ["High Contrast", "Reduced Motion", "Larger Text"]
            }]} />
              
              {/* Help */}
              <SettingsCategory title="Help" icon={<HelpCircle size={18} className="text-premium-500 mr-2" />} items={[{
              title: "FAQ",
              subitems: ["Scanning Issues", "Authentication Problems", "Product Questions"]
            }, {
              title: "Contact Support",
              subitems: ["Email", "Chat", "Phone"]
            }, {
              title: "Tutorials",
              subitems: ["Quick Start Guide", "Advanced Features", "Security Tips"]
            }]} />
              
              {/* About Us */}
              <SettingsCategory title="About Us" icon={<Users size={18} className="text-premium-500 mr-2" />} items={[{
              title: "Our Mission",
              subitems: ["Accessibility for All", "Fighting Counterfeit Products", "Building Trust"]
            }, {
              title: "The Team",
              subitems: ["Leadership", "Developers", "Advisors"]
            }, {
              title: "Legal",
              subitems: ["Privacy Policy", "Terms of Service", "Licenses"]
            }]} />
            </Accordion>
          </SheetContent>
        </Sheet>
...
const SettingsSubCategory = ({
  ...
  return <Accordion type="single" collapsible className="w-full dark:border-dark-100 border-light-400 pl-3 py-1 mb-2">
      <AccordionItem value={title.toLowerCase().replace(/\s/g, '-')} className="border-none">
        ...
        <AccordionContent>
          {customContent ? <div className="pl-2 py-2">{customContent}</div> : <div className="space-y-2 pl-2">
